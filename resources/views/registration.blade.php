...
<head>
    <title>Register - Nalanda Higher Secondary School</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    <div class="form-signin">
        <form action="{{ route('registercheck') }}" method="post">
            ...
            <h1 class="h3 fw-bold text-center">Create Account</h1>
            ...
            <div class="form-floating mb-3">
                <input type="text" name="name" class="form-control" id="floatingName" placeholder="Name" value="{{ old('name') }}">
            ...
            <button class="w-100 btn btn-lg btn-register" type="submit">Sign Up</button>
